...
#If you want the loop to stop, set speedometer_on to False
#make a for loop that changes the speed every 50 millisecounds  
...
#Sets the sleep.time to 1, making it wait 1 seconds
#The time set right now is 0.5 * 2 = 1
TIME_BETWEEN_RUNNING = 0.5
...
#hide the turtles and set colors here, Generic stuff. also speed
...
while True:
    ...
    #This is the seconds between update
    ...
    #TODO THIS IS TO GET EXAMPLE DATA
    #speed = random.randint(15, 20)
    current_list.append(speed)
    #print('Seconds Passed', len(current_list))
    ...
    time.sleep(TIME_BETWEEN_RUNNING)
